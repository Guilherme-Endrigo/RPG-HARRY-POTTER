...
namespace RPG
{
    class Maze
    {
      ...
      Console.WriteLine("| gem. Caso queira desistir, emita um sinalizador vermelho digitando \"S\".     |");
...
//hasMap=true
    ...
    static void sphinxChallenge()
    {
      ...
      switch (optionSphinx) 
      {
       ...
       //score++; life++; Ravenclaw++; Gryffindor++; Hufflepuff++; Slytherin++;
        ...
        Console.WriteLine("| finge e o seu enigma. Parabéns! Por isso, você ganhou um score e uma life! Se |");
        ...
        Console.WriteLine("|                               Enigma da Esfinge                               |");
        Console.WriteLine("|                                                                               |");
        Console.WriteLine("|    Humm… Não. Quem sabe da próxima vez? Você perdeu um score e uma life :(,   |");
        Console.WriteLine("| mas conseguiu se livrar da Esfinge com menos um score e uma life! Agora, cor- |");
    ...
    static void boggartMaze()
    {
      ...
      Console.WriteLine("| rinto com mais um score e uma life.                                           |");
      Console.WriteLine(" ------------------------------------------------------------------------------- ");
      ...
      Console.WriteLine("|-------------------------------------------------------------------------------|");
      Console.WriteLine("|                                                                               |");
      Console.WriteLine("|    O feitiço não funcionou e você perdeu um score e uma life, mas tente nova- |");
      ...
      case 2:
        ...
        Console.WriteLine("| mais um score e uma life.                                                     |");
        Console.WriteLine(" ------------------------------------------------------------------------------- ");
