  ...
  class Maze
  {
    ...
    static void sphinxChallenge(List<Character> characters)
    {
      ...
      for (int i = 0; i < characters.Count; i++)
      {
        ...
        iwhile(option != "1" && option != "2" && option != "3" && option == "")
          {
          Console.WriteLine();
          Console.WriteLine("Opção Invalida, tente novamente");
          Console.WriteLine();
    ...
    //---------> OPÇÃO 1 <---------
    static Character lumus(Character characters)
    {
      Console.WriteLine();
      Console.WriteLine();
      Console.WriteLine(" ------------------------------------------------------------------------------- ");
    ...
    //---------> OPÇÃO 2 <---------
    static Character wait(Character characters)
    {
      Console.WriteLine();
      Console.WriteLine();
      Console.WriteLine(" ------------------------------------------------------------------------------- ");
    ...
    //---------> OPÇÃO 3 <---------
    static Character Scream(Character characters)
    {
      Console.WriteLine();
      Console.WriteLine();
      Console.WriteLine(" ------------------------------------------------------------------------------- ");
