    ...
    class Dragon
    {
        ...
        static Character fightDragon(Character character)
        {
            ...
            if (diceValue >= 18)
            {
                ...
                Console.WriteLine("| certo? Parabéns! Você ganhou quatro ponto por isso :D                         |");
                Console.WriteLine("|                                                                               |");
                Console.WriteLine(" ------------------------------------------------------------------------------- ");
        ...
        static Character sabotageParticipants(Character character, List<Character> listCharacter)
        {
            ...
            Console.WriteLine("| calculado que pode temporariamente tirar um concorrente do torneio e lhe      |");
            Console.WriteLine("| conferir vantagens, porém com um alto risco envolvido. Role o dado para       |");
            Console.WriteLine("| descobrir se a sabotagem deu certo. Boa sorte!                                |");
            Console.WriteLine("|                                                                               |");
            Console.WriteLine(" ------------------------------------------------------------------------------- ");
            ...
            if (diceValue > 11)
            {
                ...
                Console.WriteLine("| participante. O participante será pego de surpresa a qualquer momento do      |");
                Console.WriteLine("| torneio! XD                                                                   |");
                Console.WriteLine("|                                                                               |");
                Console.WriteLine(" ------------------------------------------------------------------------------- ");
